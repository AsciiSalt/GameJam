-- https://github.com/sayhisam1/rbx-roact-components/blob/master/src/AutoUIScale.lua
...
function AutoUIScale:calculateRatio(minAxis, ignoreGuiInset)
	...
	--local ratio = (minAxis - minAxisSize)/delta
	--return math.clamp(ratio, self.props.minScaleRatio, self.props.maxScaleRatio)
	return math.clamp(ratio, self.props.minScaleRatio, self.props.maxScaleRatio)
end
